...
public class PanelStyle extends Panel {
    ...
    public void render(MatrixStack stack, float mouseX, float mouseY) {
        ...
        DisplayUtils.drawRoundedRect(x, y, width, header, new Vector4f(7, 0, 7, 0), ColorUtils.rgba(10, 10, 10, (int) (255 * 0.43)));

        DisplayUtils.drawRoundedRect(x, y, width, height, new Vector4f(7, 7, 7, 7), ColorUtils.rgba(5, 5, 5, (int) (255 * 0.65)));

        DisplayUtils.drawRectHorizontalW(x, y, width, header, ColorUtils.rgba(5, 5, 5, 64), ColorUtils.rgba(5, 5, 5, 0));

        DisplayUtils.drawRectVerticalW(x, y + header, width, 0.5f, ColorUtils.rgb(20, 20, 20), ColorUtils.rgb(25, 25, 25));
        Fonts.montserrat.drawCenteredText(stack, getCategory().name(), x + width / 2f, y + header / 2f - Fonts.montserrat.getHeight(headerFont) / 2f - 1, ColorUtils.rgb(120, 120, 120), headerFont, 0.1f);
        drawOutline();
        ...
        for (Style style : Expensive.getInstance().getStyleManager().getStyleList()) {
            ...
            DisplayUtils.drawRoundedRect(x + 0.5f, y + 0.5f, width - 10 - 1, 57 / 2f - 1, new Vector4f(7, 7, 7, 7), ColorUtils.rgba(5, 5, 5, (int) (255 * 0.33)));
            ...
            DisplayUtils.drawRoundedRect(x, y, width - 10, 57 / 2f, new Vector4f(7, 7, 7, 7), new Vector4i(ColorUtils.rgb(30, 30, 30), ColorUtils.rgb(0, 0, 0), ColorUtils.rgb(30, 30, 30), ColorUtils.rgb(0, 0, 0)));

            Stencil.uninitStencilBuffer();

            Fonts.montserrat.drawText(stack, style.getStyleName(), x + 5, y + 5, ColorUtils.rgb(150, 150, 150), 6f, 0.05f);
