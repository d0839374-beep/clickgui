...
public class Panel implements IBuilder {
    ...
    public void render(MatrixStack stack, float mouseX, float mouseY) {
        ...
        DisplayUtils.drawRoundedRect(x, y, width, header, new Vector4f(7, 0, 7, 0),
                ColorUtils.rgba(10, 10, 10, (int) (255 * 0.43)));

        DisplayUtils.drawRoundedRect(x, y, width, height, new Vector4f(7, 7, 7, 7),
                ColorUtils.rgba(5, 5, 5, (int) (255 * 0.65)));

        DisplayUtils.drawRectHorizontalW(x, y, width, header,
                ColorUtils.rgba(5, 5, 5, 64), ColorUtils.rgba(5, 5, 5, 0));

        DisplayUtils.drawRectVerticalW(x, y + header, width, 0.5f, ColorUtils.rgb(20, 20, 20),
                ColorUtils.rgb(25, 25, 25));

        Fonts.montserrat.drawCenteredText(stack, category.name(), x + width / 2f,
                y + header / 2f - Fonts.montserrat.getHeight(headerFont) / 2f - 1, ColorUtils.rgb(120, 120, 120),
                headerFont, 0.1f);
        ...
        DisplayUtils.drawRoundedRect(x, y + height - header, width, header, new Vector4f(0, 7, 0, 7),
                new Vector4i(Color.TRANSLUCENT, ColorUtils.rgba(10, 10, 10, (int) (255 * 0.33)), Color.TRANSLUCENT,
                        ColorUtils.rgba(10, 10, 10, (int) (255 * 0.33))));
    ...
    protected void drawOutline() {
        ...
        DisplayUtils.drawRoundedRect(x, y, width, height,
                ...
                new Vector4i(ColorUtils.rgb(30, 30, 30), ColorUtils.rgb(0, 0, 0), ColorUtils.rgb(30, 30, 30),
